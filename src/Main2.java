...
class RAMDirectoryExample {
    ...
    static void writeIndex(RAMDirectory ramDir, Analyzer analyzer) {
        try {
            ...
            indexDoc(writer, "document-1", "hello has the world",analyzer);
            indexDoc(writer, "document-2", "hello happiest world",analyzer);
            indexDoc(writer, "document-3", "hello happy World",analyzer);
            indexDoc(writer, "document-4", "hello hello makes world",analyzer);
    ...
    static void indexDoc(IndexWriter writer, String name, String content,Analyzer analyzer) throws IOException {
        Document doc = new Document();
//        FieldType ft = new FieldType(TextField.TYPE_STORED);
//        ft.setStoreTermVectors(true);
        TokenStream tokenStream = analyzer.tokenStream("content",content);
//        Field f = new Field("content",content,ft);
//        f.setTokenStream(ts);
//        doc.add(f);
